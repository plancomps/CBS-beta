...
CBS-DIRS   = $(shell find *-beta -type f -name '*.cbs' -exec dirname {} \; )
CBS-FILES  = $(shell find *-beta -type f -name '*.cbs' )

# Generated by make docs
DOCS-FILES = $(CBS-DIRS:%=_docs/%/index.md)

# Generated by make math
MATH-FILES = $(CBS-DIRS:%=_math/%/index.md) $(CBS-FILES:%.cbs=_math/%.tex) $(CBS-FILES:%.cbs=_math/%.md)
...
TOC-FILES  = $(CBS-FILES:%.cbs=_math/%.toc)

.PHONY: clean maintainer-clean clean-docs clean-math
